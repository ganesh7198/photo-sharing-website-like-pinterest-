...
const Profilepage = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        const url = `http://localhost:5000/api/user/profile/${targetUsername}`;
  ...
  const handleFollow = async () => {
    ...
    try {
      ...
      setProfile((prev) => ({
        ...
        isFollowing: res.data.followers.includes(userInfo._id),
      }));
    } catch (err) {
  ...
  const isFollowing = userInfo?.following?.includes(profile._id) || false;
        ...
        <div className="mb-12">
          <div className="flex items-center gap-8">
            ...
            <div className="relative">
              <div className="w-36 h-36 rounded-full p-1 border-2 border-gradient-to-r from-purple-500 to-pink-500">
                <img
                ...
                <div className="flex items-center gap-3">
                  {isOwnProfile ? (
                    ...
                    <>
                      ...
                      <button className="px-4 py-1.5 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium">
                        Message
                      </button>
                    </>
                  )}
